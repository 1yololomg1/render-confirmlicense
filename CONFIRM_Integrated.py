...
class LicenseDialog:
    ...
    disclaimer = """TERMS OF USE AND LIABILITY DISCLAIMER

BY USING THIS SOFTWARE, YOU ACKNOWLEDGE AND AGREE:

1. NO WARRANTIES: CONFIRM is provided "AS IS" without warranties of any kind. TraceSeis, Inc. disclaims all warranties, express or implied, including merchantability, fitness for particular purpose, and non-infringement.

2. LIMITATION OF LIABILITY: TraceSeis, Inc. shall not be liable for any direct, indirect, incidental, consequential, or punitive damages arising from your use of this software, including but not limited to lost profits, business interruption, or data loss.

3. USER RESPONSIBILITY: You assume full responsibility for any business decisions, research conclusions, or actions taken based on CONFIRM's statistical analysis results. You are solely responsible for validating and interpreting all outputs.

4. STATISTICAL ANALYSIS LIMITATIONS: Statistical validation software provides analytical tools but cannot guarantee accuracy of interpretations, business decisions, or scientific conclusions. Users must apply appropriate domain expertise and additional validation methods.

5. MAXIMUM LIABILITY: Our total liability to you for all damages shall not exceed the amount paid for your license.

6. INDEMNIFICATION: You agree to indemnify TraceSeis, Inc. against any claims arising from your use of this software.

7. PROFESSIONAL CONSULTATION: For critical business or re
...
This proprietary software is part of the TraceSeis, Inc. Professional Suite.
Unauthorized copying, distribution, or modification is strictly prohibited.

Licensed under TraceSeis, Inc. Commercial License Agreement.
...
Author: deltaV solutions Development Team (TraceSeis, Inc.)
Contact: info@deltavsolutions.com
