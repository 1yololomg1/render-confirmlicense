...
EXE-Ready Version with proper path handling
"""
...
# EXE-compatible path handling
def get_app_data_dir():
    """Get application data directory, works for both Python and EXE"""
    ...
    # Create .confirm directory in user's home
